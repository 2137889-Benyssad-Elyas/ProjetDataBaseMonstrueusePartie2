...
INSERT INTO Monstre (id_monstre, nom, code_employe, point_vie, attaque, numero_ass_maladie, id_famille, experience) VALUES
	(1, 'Carl', 'C003', 12, 3, cryptage('CARL 5606 3111'), 1, 0),
	(2, 'Boris', 'B004', 12, 3, cryptage('BORI 5875 3527'), 1, 0),
	(3, 'Edward Cullen', 'E001', 36, 8, cryptage('EDWA 4982 1003'), 3, 12),
	(4, 'Morgoth', 'M007', 36, 8, cryptage('MORG 8923 6524'), 2, 15),
	(5, 'Syra', 'S024', 42, 6, cryptage('SYRA 9791 7455'), 4, 18),
	(6, 'Néphérite', 'N888', 86, 9, cryptage('NÉPH 9879 6949'), 5, 120),
	(7, 'Garry', 'G420', 7, 2, cryptage('GARR 2687 2815'), 9, 5),
	(8, 'Jerry', 'J420', 7, 2, cryptage('JERR 9428 2918'), 9, 5),
	(9, 'Terry', 'T420', 7, 2, cryptage('TERR 7754 8029'), 9, 5),
	(10, 'Larry', 'L420', 7, 2, cryptage('LARR 3540 8390'), 9, 5),
	(11, 'Molustus', 'M666', 55, 12, cryptage('MOLU 5965 1164'), 8, 25),
	(12, 'Combustus', 'C457', 55, 12, cryptage('COMB 1235 5017'), 8, 34),
	(13, 'Aero', 'A875', 29, 9, cryptage('AERO 6682 1603'), 6, 19),
	(14, 'Miro', 'M442', 29, 9, cryptage('MIRO 8066 2007'), 6, 0),
	(15, 'Nefustus', 'N410', 37, 6, cryptage('NEFU 9123 3159'), 7, 12),
	(16, 'Albertus', 'A002', 37, 6, cryptage('ALBE 4055 3115'), 7, 4),
	(17, 'Clyde', 'C876', 15, 4, cryptage('CLYD 4232 5481'), 10, 3),
	(18, 'Bonnie', 'B452', 15, 4, cryptage('BONN 9211 5333'), 10, 8),
	(19, 'Korg', 'K374', 12, 4, cryptage('KORG 9518 8644'), 11, 5),
	(20, 'Buld', 'B350', 12, 4, cryptage('BULD 6936 3187'), 11, 7),
	(21, 'Norm', 'N583', 12, 4, cryptage('NORM 5410 5440'), 11, 9),
	(22, 'Ywan', 'Y690', 12, 4, cryptage('YWAN 6347 6248'), 11, 15),
	(23, 'Molg', 'M256', 12, 4, cryptage('MOLG 2696 5245'), 11, 2),
	(24, 'Euld', 'E248', 12, 4, cryptage('EULD 7169 3555'), 11, 0),
	(25, 'Bizomo', 'B754', 6, 2, cryptage('BIZO 3762 7149'), 12, 0),
	(26, 'Kallioko', 'K475', 6, 2, cryptage('KALL 8143 5343'), 12, 3),
	(27, 'Ariama', 'A320', 6, 2, cryptage('ZORI 2256 9932'), 12, 2),
	(28, 'Burt', 'B867', 36, 8, cryptage('BURT 7912 6165'), 2, 21),
	(29, 'Larry', 'L920', 42, 6, cryptage('LARR 6664 3021'), 3, 14),
	(30, 'Zoriama', 'Z687', 86, 9, cryptage('ZORI 9266 3075'), 4, 2);
